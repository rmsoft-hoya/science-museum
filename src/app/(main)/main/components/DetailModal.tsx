            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="leading-[140%] text-sm">
                <p className="indent-1">
                  측우대는 강우량을 측정하는 기기인 측우기를 안정되게 얹히기 위 한 받침돌로 윗면이 오목하게 파인 사각기둥 형태를 가지고 있다. <br />
                  <br />
                </p>
                <p className="indent-1">
                  통영측우대는 19세기 경남 통영에 위치한 수군 통제영에서 설치했 던 것으로 1910년경 관측소(현 기상청)로 옮겨서 보관되었다.
                  <br />
                  <br />
                </p>
                <p className="indent-1">
                  이후 1972년부터는 서울과학관에서, 그리고 2008년부터는 국립중앙과 학관에서 전시되고 있다.
                  <br />
                  <br />
                </p>
                <p className="indent-1">
                  통영측우대는 현존하는 측우대 중 유일하게 받침대를 갖추고 있으 며, ‘測雨臺(측우대)’라는 명칭과 ‘辛未 二月(신미 2월)’이라고 제작 연대가 명확하게
                  새겨져 있다.
                  <br />
                  <br />
                </p>
                <p className="indent-1">
                  이는 조선시대 전국 기상 관측망의 존재를 입증하는 중요한 증거로서, 우리나라가 세계에서 가장 오랜 기간의 강우량 기록을 보유한 국가임을 확인하는
                  중요한 자료이다.
                  <br />
                  <br />
                </p>
                <p className="indent-1">이러한 역사적 가치를 인정받아 2010년에 보물 제1652호로 지정되 었다.</p>
              </p>
            </div>
          </div>
        </div>
