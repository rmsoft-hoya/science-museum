        ...
        <div className="overflow-y-auto px-4">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="leading-[140%] text-sm indent-3">
                그 중 통영 측우대(보물)는 현존하는 측우대 중 유일하게 받침대 를 갖추고 있으며, ‘測雨臺(측우대)’와 ‘辛未二月(신미 2월)’이라는 명문이 있어 명칭과
                제작 연대도 알 수 있다.
              </p>
              <p className="leading-[140%] text-sm indent-3">
                측우기와 측우대는 조선시대 기상 관측을 입증하는 중요한 증거로, 우리나라가 세계에서 가장 오랜 기간 강우량 측정 및 기록을 보유한 국가임을 알 수
                있는 중요한 자료이다.
              </p>
            </div>
          </div>
